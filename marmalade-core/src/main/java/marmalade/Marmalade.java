/*
 ...
 /__,_/ /__/\__,_/_/  /_/ /_/ /_/\__,_/_/\__,_/\__,_/\___/   2012-2013 mfornos
...
/**
 * <p>
 * Fluent API for comfortable HTTP interactions. Marmalade offers a simple yet
 ...
 * 
 * Post(uri).bean(in).execute();
 * 
 * // Post a bean as json
 * 
 * Post(uri).bean(inBean).as(APPLICATION_JSON).send();
 * 
 * // or
 * 
...
public final class Marmalade
{
    ...
    */
   public static Marmalade Delete(String uri)
   {
    ...
    * @return builder instance
    */
   public static Marmalade Get(String uri)
   {
      return new Marmalade(new HttpGet(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Get(URI uri)
   {
      return new Marmalade(new HttpGet(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Head(String uri)
   {
      return new Marmalade(new HttpHead(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Head(URI uri)
   {
      return new Marmalade(new HttpHead(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Options(String uri)
   {
      return new Marmalade(new HttpOptions(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Options(URI uri)
   {
      return new Marmalade(new HttpOptions(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Patch(String uri)
   {
      return new Marmalade(new HttpPatch(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Patch(URI uri)
   {
      return new Marmalade(new HttpPatch(uri));
   }
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Post(String uri)
   {
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Post(String uri, ContentType contentType)
   {
      return new Marmalade(new HttpPost(uri)).as(contentType);
   }
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Post(URI uri)
   {
      return Post(uri, ContentType.APPLICATION_FORM_URLENCODED);
   }
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Post(URI uri, ContentType contentType)
   {
      return new Marmalade(new HttpPost(uri)).as(contentType);
   }
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Put(String uri)
   {
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Put(String uri, ContentType contentType)
   {
      return new Marmalade(new HttpPut(uri)).as(contentType);
   }
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Put(URI uri)
   {
      return Put(uri, ContentType.APPLICATION_FORM_URLENCODED);
   }
    ...
    * @see #as(ContentType)
    */
   public static Marmalade Put(URI uri, ContentType contentType)
   {
      return new Marmalade(new HttpPut(uri)).as(contentType);
   }
    ...
    * @return builder instance
    */
   public static Marmalade Trace(String uri)
   {
      return new Marmalade(new HttpTrace(uri));
   }
    ...
    * @return builder instance
    */
   public static Marmalade Trace(URI uri)
   {
      return new Marmalade(new HttpTrace(uri));
   }
    ...
    * @see HttpHeaders
    */
   public Marmalade addHeader(final Header header)
   {
    ...
    * @see ContentType
    */
   public Marmalade as(ContentType contentType)
   {
    ...
    */
   public Marmalade auth(String username, String password)
   {
    ...
    * @see #as(ContentType)
    */
   public Marmalade bean(Object bean)
   {
      this.bean = bean;
      return this;
   }
    ...
    * @return builder instance
    */
   public Marmalade config(final String param, final Object object)
   {
    ...
    * @return builder instance
    */
   public Marmalade connectTimeout(int timeout)
   {
    ...
    * @return builder instance
    */
   public Marmalade decorate(Closure<HttpRequestBase> closure)
   {
    ...
    * @return builder instance
    */
   public Marmalade elementCharset(final String charset)
   {
    ...
    * @return builder instance
    */
   public Marmalade entity(HttpEntity entity)
   {
      this.entity = entity;
      return this;
   }
    ...
    * @return builder instance
    */
   public Marmalade removeConfig(final String param)
   {
    ...
    * @return builder instance
    */
   public Marmalade removeHeader(final Header header)
   {
    ...
    * @return builder instance
    */
   public Marmalade setCacheControl(String cacheControl)
   {
    ...
    * @see #getDateFormat()
    */
   public Marmalade setDate(final Date date)
   {
    ...
    * @return builder instance
    */
   public Marmalade setDateFormat(DateFormat format)
   {
    ...
    * @return builder instance
    */
   public Marmalade setHeaders(final Header[] headers)
   {
    ...
    * @return builder instance
    */
   public Marmalade setIfModifiedSince(final Date date)
   {
    ...
    * @return builder instance
    */
   public Marmalade setIfUnmodifiedSince(final Date date)
   {
    ...
    * @return builder instance
    */
   public Marmalade socketTimeout(int timeout)
   {
    ...
    * @return builder instance
    */
   public Marmalade staleConnectionCheck(boolean b)
   {
    ...
    * @return builder instance
    */
   public Marmalade useExpectContinue()
   {
    ...
    * @return builder instance
    */
   public Marmalade userAgent(final String agent)
   {
    ...
    * @return builder instance
    */
   public Marmalade version(final HttpVersion version)
   {
    ...
    * @return builder instance
    */
   public Marmalade viaProxy(final HttpHost proxy)
   {
