...
public class CircularByteBuffer
{
    ...
    * empty buffer will have the markPostion and the writePosition equal to each
    * other. A full buffer will have the writePosition one less than the
    * markPostion.
    * <p>
    ...
    * been saved to support a reset() of the InputStream go from markPosition to
