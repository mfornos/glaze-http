...
public class TestMapperResponseHandler
{
   ...
   @Test(expectedExceptions = GlazeException.class, expectedExceptionsMessageRegExp = "Unable to resolve mapper for type 'text/plain' in namespace 'default'")
   ...
   @Test(expectedExceptions = GlazeException.class)
