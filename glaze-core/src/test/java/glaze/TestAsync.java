...
public class TestAsync extends BaseHttpTest
{
   ...
   public void send() throws InterruptedException, ExecutionException
   {
      ...
      try {
         ...
         futures.add(Glaze.Post(baseUrl + "/areq").bean("hello").as(ContentType.DEFAULT_TEXT).sendAsync(client));
         futures.add(Glaze.Get(baseUrl + "/areq").sendAsync(client, new BasicHttpContext()));
         futures.add(Glaze.Put(baseUrl + "/areq").bean("hello").as(ContentType.DEFAULT_TEXT).sendAsync(client, new BasicHttpContext()));
         futures.add(Glaze.Head(baseUrl + "/areq").sendAsync(client));
         futures.add(Glaze.Delete(baseUrl + "/areq").sendAsync(client));
   ...
   public void sendCallback() throws InterruptedException, ExecutionException
   {
      ...
      try {
         ...
         futures.add(Glaze.Put(baseUrl + "/areq").bean("hello").as(ContentType.DEFAULT_TEXT).sendAsync(client, new BasicHttpContext(), callback));
         futures.add(Glaze.Head(baseUrl + "/areq").sendAsync(client, new BasicHttpContext(), callback));
         futures.add(Glaze.Delete(baseUrl + "/areq").sendAsync(client, callback));
